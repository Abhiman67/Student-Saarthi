    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500 max-w-2xl">
          Choose a specialized agent tailored to your immediate academic task. Each mentor maintains
          dedicated context, safe evaluation boundaries, and human-in-the-loop approval cards.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        {recentConversations.length === 0 ? (
          <div className="rounded-xl border border-dashed border-slate-200 p-8 text-center text-slate-400 text-xs">
            No active conversations. Pick an agent above to start learning or planning a project.
          </div>
        ) : (
